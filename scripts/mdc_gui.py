...
###########################################################################
## Class DXLink_Configurator_Frame
###########################################################################

class DXLink_Configurator_Frame ( wx.Frame ):
...
class MSE_Baseline ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.mse_manual_grid.SetColLabelAlignment( wx.ALIGN_CENTER, wx.ALIGN_CENTER )

		# Rows
		self.mse_manual_grid.AutoSizeRows()
		self.mse_manual_grid.EnableDragRowSize( False )
		self.mse_manual_grid.SetRowLabelSize( 0 )
		self.mse_manual_grid.SetRowLabelAlignment( wx.ALIGN_CENTER, wx.ALIGN_CENTER )
